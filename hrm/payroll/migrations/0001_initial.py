...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ExpenseClaimSettings',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_method', models.CharField(choices=[('separately', 'Separately'), ('with_net_pay', 'with NET PAY')], default='separately', help_text='How expense claims are paid to employees', max_length=20)),
                ('mandatory_attachment', models.CharField(choices=[('yes', 'Yes'), ('no', 'No')], default='no', help_text='Whether attachments are required for claims', max_length=10)),
                ('mileage_rate_currency', models.CharField(default='KES', max_length=10)),
                ('mileage_rate_amount', models.DecimalField(decimal_places=2, default=152.0, max_digits=10)),
                ('mileage_rate_unit', models.CharField(default='Per km', max_length=20)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('expense_type', models.CharField(choices=[('tt', 'Travel Tickets'), ('ac', 'Accommodation'), ('ml', 'Meals'), ('jm', 'Job Materials'), ('os', 'Office Supplies'), ('mh', 'Medical Help'), ('tr', 'Transport'), ('mlg', 'Mileage'), ('other', 'Other')], max_length=100)),
                ('application_date', models.DateField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('report_type', models.CharField(choices=[('p9', 'P9'), ('p10a', 'P10A'), ('statutory', 'Statutory Deductions'), ('bank_net_pay', 'Bank Net Pay'), ('muster_roll', 'Muster Roll'), ('withholding_tax', 'Withholding Tax'), ('variance', 'Variance')], max_length=50)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['report_type'], name='idx_custom_report_type'), models.Index(fields=['created_by'], name='idx_custom_report_user')],
