    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allow_ess', models.BooleanField(default=False, help_text='Enable Employee Self-Service portal access for this employee', verbose_name='Allow ESS Access')),
                ('ess_activated_at', models.DateTimeField(blank=True, help_text='Date when ESS access was first activated', null=True, verbose_name='ESS Activated On')),
                ('ess_last_login', models.DateTimeField(blank=True, help_text='Last time employee logged into ESS portal', null=True, verbose_name='ESS Last Login')),
                ('ess_unrestricted_access', models.BooleanField(default=False, help_text='Allow ESS login regardless of shift rotation, off days, or leave status. Only for managers/supervisors.', verbose_name='Unrestricted ESS Access')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'job_groups',
                'managed': True,
                'indexes': [models.Index(fields=['title'], name='idx_job_group_title')],
            },
        ),
        migrations.CreateModel(
            name='JobTitle',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_shift', models.ForeignKey(blank=True, help_text='Work shift assigned to employee', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='salary_details', to='attendance.workshift')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'managed': True,
                'indexes': [models.Index(fields=['name'], name='idx_workers_union_name'), models.Index(fields=['code'], name='idx_workers_union_code')],
            },
        ),
        migrations.AddIndex(
            model_name='employee',
        ...
        migrations.AddIndex(
            model_name='employee',
            index=models.Index(fields=['allow_ess'], name='idx_employee_allow_ess'),
        ),
        migrations.AddIndex(
            model_name='employee',
            index=models.Index(fields=['ess_activated_at'], name='idx_employee_ess_activated'),
        ),
        migrations.AddIndex(
            model_name='employee',
            index=models.Index(fields=['ess_unrestricted_access'], name='idx_employee_ess_unrestricted'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='salarydetails',
            index=models.Index(fields=['work_shift'], name='idx_salary_details_work_shift'),
        ),
    ]
