...
from ...payroll_settings.services.utils import get_approval_thresholds, get_approver_by_role_and_department
...
class PayrollApprovalService:
    ...
    def __init__(self):
        self.payroll_content_types = {
            ...
            'casual_voucher': ContentType.objects.get_for_model(CasualVoucher),
            'consultant_voucher': ContentType.objects.get_for_model(ConsultantVoucher),
        }
