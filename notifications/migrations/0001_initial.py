    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_email', models.EmailField(default='gadmin@masterserpace.co.ke', max_length=100)),
                ('from_name', models.CharField(default='Masters ERP', max_length=100)),
                ('smtp_host', models.CharField(default='smtppro.zoho.com', max_length=100)),
