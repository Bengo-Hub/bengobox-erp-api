    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_sid', models.CharField(blank=True, help_text='For Twilio', max_length=255, null=True)),
                ('auth_token', models.CharField(blank=True, help_text='For Twilio/AfricasTalking', max_length=255, null=True)),
                ('from_number', models.CharField(blank=True, help_text='For Twilio', max_length=20, null=True)),
                ('api_key', models.CharField(blank=True, help_text='For AfricasTalking/Nexmo', max_length=255, null=True)),
                ('api_username', models.CharField(blank=True, help_text='For AfricasTalking', max_length=100, null=True)),
                ('aws_access_key', models.CharField(blank=True, help_text='For AWS SNS', max_length=255, null=True)),
                ('aws_secret_key', models.CharField(blank=True, help_text='For AWS SNS', max_length=255, null=True)),
