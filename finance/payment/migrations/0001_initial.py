    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direction', models.CharField(choices=[('in', 'Money In'), ('out', 'Money Out')], default='in', help_text='Money flow direction', max_length=10)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=15)),
                ('payment_method', models.CharField(choices=[('cash', 'Cash'), ('mpesa', 'M-Pesa'), ('card', 'Credit/Debit Card'), ('paypal', 'PayPal'), ('stripe', 'Stripe'), ('bank', 'Bank Transfer'), ('cod', 'Cash on Delivery'), ('cheque', 'Cheque')], max_length=20)),
                ...
                ('mobile_money_provider', models.CharField(blank=True, choices=[('mpesa', 'M-Pesa'), ('airtel_money', 'Airtel Money')], help_text='Mobile money provider used for payment', max_length=20, null=True)),
                ...
                ('approval_threshold', models.DecimalField(blank=True, decimal_places=2, help_text='Auto-approval threshold', max_digits=15, null=True)),
                ...
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='finance_payments', to='business.branch')),
                ('customer', models.ForeignKey(blank=True, help_text='Customer for money IN', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payments_received', to='contacts.contact')),
                ('payment_account', models.ForeignKey(blank=True, help_text='Account from/to which payment flows', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='payments', to='accounts.paymentaccounts')),
                ('supplier', models.ForeignKey(blank=True, help_text='Supplier for money OUT', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payments_made', to='contacts.contact')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payment_transactions', to='business.branch')),
